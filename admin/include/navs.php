...
?>
		...
		<nav class="navbar navbar-expand bg-secondary navbar-dark sticky-top px-4 py-0">
				...
				?>
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link" data-bs-toggle="dropdown">
                            <img class="rounded-circle me-lg-2" src="img/limg/<?php echo $userinfo['image']?>" alt="" style="width: 40px; height: 40px;">
                            <span class="d-none d-lg-inline-flex"><?php echo $userinfo['name']?></span>
                        </a>
                    </div>
